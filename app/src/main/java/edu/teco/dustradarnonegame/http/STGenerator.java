package edu.teco.dustradarnonegame.http;

import java.net.URISyntaxException;

import edu.teco.dustradarnonegame.data.DataObject;
import edu.teco.dustradarnonegame.sensorthings.Datastream;
import edu.teco.dustradarnonegame.sensorthings.FeatureOfInterest;
import edu.teco.dustradarnonegame.sensorthings.Observation;
import edu.teco.dustradarnonegame.sensorthings.ObservedProperty;
import edu.teco.dustradarnonegame.sensorthings.Sensor;
import edu.teco.dustradarnonegame.sensorthings.Thing;
import edu.teco.dustradarnonegame.sensorthings.geojson.GeoPoint;
import edu.teco.dustradarnonegame.sensorthings.helper.UnitOfMeasurement;
