...
import edu.teco.dustradarnonegame.R;
import edu.teco.dustradarnonegame.bluetooth.BLEScan;
    ...
    private final BroadcastReceiver mReceiver = (new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BLEService.BROADCAST_BLESERVICE_FIRST_CONNECT.equals(action)) {
                ...
                // start BLEBridgeHandler Fragment then immediately Start record sensor data and send them!
                ArrayList<String> deviceAddress = new ArrayList<>();
